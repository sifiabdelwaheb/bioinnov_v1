(function($) {
    ...
    $(".case-active").slick({
        ...
        autoplay: false,
        speed: 800,
        prevArrow: '<button type="button" class="slider-prev slider-arrow"><i class="fas fa-angle-left"></i></button>',
        nextArrow: '<button type="button" class="slider-next slider-arrow"><i class="fas fa-angle-right"></i></button>',
        slidesToShow: 4,
        slidesToScroll: 2,
        responsive: [{
                breakpoint: 1465,
    ...
    $(".review--active").slick({
        ...
        autoplay: true,
        speed: 800,
        prevArrow: '<button type="button" class="slider-prev slider-arrow"><i class="flaticon flaticon-previous"></i></button>',
        nextArrow: '<button type="button" class="slider-next slider-arrow"><i class="flaticon flaticon-next"></i></button>',
        slidesToShow: 3,
        slidesToScroll: 1,
        responsive: [{
                breakpoint: 1191,
