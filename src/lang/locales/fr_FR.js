...
module.exports = {
  ...
  "menu.Subsidiaries": "Nos Filiales",
  ...
  "button.account": "Créer un compte",
  "button.send": "Envoyer",
  ...
  "forms.name": "Name",
  "form-loginto": "Se connecter à International BioService",
  ...
  "dashboards.about": " À Props",
  "forget.password": "Mot de passe oublié ?",
  "verif.account": "Vous n'avez pas de compte ?",

  //pages
  "home.title": "Meilleur Fournisseur De Solutions",
  "home.description":
    "La meilleure solution pour exécuter votre projet plus rapidement Nous offrons des solutions personnalisées pour résoudre vos problèmes ou inconvénients spécifiques liés au travail. Des solutions informatiques pour faciliter le flux de travail, pour une meilleure gestion des ressources humaines, pour une meilleure organisation de vos tâches et projets.",
  //Our Services page
  "services.title": "NOS SERVICES",
  "services.Health": "Soins De Santé",
  "services.Healthdescription":
    "nous travaillons sur des projets liés au secteur de la santé avec des instituts nationaux, internationaux, publics et privés.",
  "services.software": "Développement De Logiciels",
  "services.softdescription":
    "Notre équipe informatique développe des solutions personnalisées pour vos besoins spécifiques.",
  "services.Consulting": "Conseil Et Assistance",
  "services.Consuldescription":
    " Nos experts vous aident à faire évoluer votre entreprise et à mieux développer votre idée pour en faire une entreprise viable.",
  "services.artificial": "Intelligence Artificielle",
  "services.artificialdescription":
    " Nos experts ont une grande expérience de l'intelligence artificielle et de l'apprentissage automatique qui vous permettra de faire passer votre entreprise au niveau supérieur.",
  "services.it": "Conseil En Informatique",
  "services.itdescription":
    " Nos experts en informatique ( avec plus de 15 ans d'expérience) peuvent vous aider dans vos solutions informatiques",
  "studies.did": "CE QUE NOUS AVONS FAIT",
  "studies.solutions": "Nos solutions Et Projets",
  "studies.plantval":
    "Une solution intelligente pour valoriser notre précieuse flore",
  "studies.chentayeb":
    " Une solution intelligente pour la commercialisation locale des produits",
  "studies.genomet": " Solution d'e-santé pour une médecine personnalisée",
  "studies.green": "Une solution intelligente pour le tourisme",
  "area.title": "NOUS OFFRONS LES MEILLEURS SERVICES INFORMATIQUES",
  "area.description":
    "Des solutions faciles pour tous les problèmes informatiques difficiles",
  "area.Partners": "Nos partenaires",
  "area.Awards": "Notre prix",
  "contacts.location": "Notre Emplacement",
  "contacts.email": "Adresse électronique",
  "contacts.call": "Appelez-nous Gratuitement",
  "contacts.touch": "CONTACTEZ-NOUS",
  "contacts.description":
    "Êtes-vous prêt à améliorer votre entreprise et à la rendre plus productive ?",
  "contacts.name": "Nom *",
  "contacts.email": "Email *",
  "contacts.phone": "téléphone *",
  "contacts.message": "Message *",
  "about.company": "À PROPOS DE L'ENTREPRISE",
  "about.promise": "Ce que nous promettons Des services de haute qualité",
  "about.experience": "ANS D'EXPÉRIENCE",
  "team.title": "NOTRE ÉQUIPE",
  "button.details": "Obtenir des détails",
